...
//!
//! Per-**device** scope. It waits on a hostname to accrue in the archive — the capture side shipped
//! on 2026-08-25, so the field exists and the history does not, and a control whose only option is
//! "the machine I deployed from" is a control that says nothing. It is a later slice over this same
