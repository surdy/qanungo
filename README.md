...
window controls**, the **pipeline health** panel, the **ask box**, the **five lanes**, the **timeline**,
the **habits heatmap**, the **findings**, the **cost** breakdown, and the **standup** narrative, over a
provenance footer.
